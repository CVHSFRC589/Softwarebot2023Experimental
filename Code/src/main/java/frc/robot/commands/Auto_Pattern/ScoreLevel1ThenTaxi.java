...
public class ScoreLevel1ThenTaxi extends SequentialCommandGroup {
  /** Creates a new Score3Cube. */
  public ScoreLevel1ThenTaxi(ArmSubsystem arm, DriveSubsystem drive, GripperSubsystem grip, WristSubsystem wrist) {
